...
Java_com_wpf_ffmpegcmd_FFmpegCmd_exec(JNIEnv *env, jclass clazz, jint cmdnum, jobjectArray cmdline)
{
...
Java_com_wpf_ffmpegcmd_FFmpegCmd_exit(JNIEnv *env, jclass type)
{
